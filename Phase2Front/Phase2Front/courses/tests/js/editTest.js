document.addEventListener("DOMContentLoaded", function () {
    ...
    if (controller === "tests") {
        ...
        testModule.getTestById(id, courseID, function (test) {
            loadForm(test);
        });
        setupTestSubmit(id, courseID);
    }
...
function setupTestSubmit(id, cid) {
    ...
    form.onsubmit = function (e) {
        ...
        testModule.updateTest(id, cid, newTest, function () {
